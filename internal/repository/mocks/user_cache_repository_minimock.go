...
//go:generate minimock -i github.com/Kosfedev/auth/internal/repository.UserCacheRepository -o user_cache_repository_minimock.go -n UserCacheRepositoryMock -p mocks
...
func (mmCreate *mUserCacheRepositoryMockCreate) Expect(ctx context.Context, userData *model.UserData) *mUserCacheRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserCacheRepositoryMockCreateParams{ctx, userData}
...
// ExpectUserDataParam2 sets up expected param userData for UserCacheRepository.Create
func (mmCreate *mUserCacheRepositoryMockCreate) ExpectUserDataParam2(userData *model.UserData) *mUserCacheRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserCacheRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserCacheRepositoryMockCreate) Inspect(f func(ctx context.Context, userData *model.UserData)) *mUserCacheRepositoryMockCreate {
...
func (mmCreate *mUserCacheRepositoryMockCreate) Set(f func(ctx context.Context, userData *model.UserData) (i1 int64, err error)) *UserCacheRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserCacheRepositoryMockCreate) When(ctx context.Context, userData *model.UserData) *UserCacheRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserCacheRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &UserCacheRepositoryMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &UserCacheRepositoryMockCreateParams{ctx, userData},
...
func (mmCreate *UserCacheRepositoryMock) Create(ctx context.Context, userData *model.UserData) (i1 int64, err error) {
	...
	mm_params := UserCacheRepositoryMockCreateParams{ctx, userData}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserCacheRepositoryMockCreateParams{ctx, userData}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userData != nil && !minimock.Equal(*mm_want_ptrs.userData, mm_got.userData) {
				mmCreate.t.Errorf("UserCacheRepositoryMock.Create got unexpected parameter userData, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to UserCacheRepositoryMock.Create. %v %v", ctx, userData)
	return
}
...
func (mmGet *mUserCacheRepositoryMockGet) Return(up1 *model.UserData, err error) *UserCacheRepositoryMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserCacheRepositoryMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserCacheRepositoryMockGet) Set(f func(ctx context.Context, id int64) (up1 *model.UserData, err error)) *UserCacheRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserCacheRepositoryMockGetExpectation) Then(up1 *model.UserData, err error) *UserCacheRepositoryMock {
...
func (mmGet *UserCacheRepositoryMock) Get(ctx context.Context, id int64) (up1 *model.UserData, err error) {
